...
namespace model_icl_speed2_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_icl_speed2");
    reader.add_event(239, 237, "end", "model_icl_speed2");
    return reader;
}
...
class model_icl_speed2 : public prob_grad {
private:
        int M;
        int P;
        int N0;
...
public:
    model_icl_speed2(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_icl_speed2_namespace::model_icl_speed2";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_icl_speed2_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_icl_speed2_namespace::model_icl_speed2 stan_model;
#endif
