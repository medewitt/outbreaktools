...
namespace model_icl_speed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_icl_speed");
    reader.add_event(133, 131, "end", "model_icl_speed");
    return reader;
}
#include <stan_meta_header.hpp>
class model_icl_speed : public prob_grad {
private:
        int M;
        int P;
        int N0;
...
public:
    model_icl_speed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_icl_speed_namespace::model_icl_speed";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_icl_speed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_icl_speed_namespace::model_icl_speed stan_model;
#endif
